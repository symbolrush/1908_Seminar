...
[^35]: CRAN, The Comprehensive R Archive Network, ist die wichtigste Plattform für \textsf{R} Code.
...
`testthat` stellt Expectations zur Verfügung zum Testen, ob ein Objekt von einer S3 oder S4 Klasse erbt oder einen \textsf{R} base Typen hat. 
...
* `expect_type()`: Testet, ob ein Objekt ein \textsf{R} base Typ hat. Nutzt die \textsf{R} base Funktion `typeof()`.
...
[^212]: The Comprehensive R Archive Network https://cran.r-project.org/
